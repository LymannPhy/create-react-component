...
export const UserReview = () => {
  return (
    <>
      <h1 className='text-3xl text-center mt-10 font-bold text-pink-500'>Our Testimonials</h1>
      <div className="max-screen-w-xl w-full grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-16 gap-5 mx-auto mt-10">
        ...
        >
          <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
            <Avatar src="https://i.pinimg.com/736x/9b/e5/3e/9be53e1171d76e03734b4b5ac01d6649.jpg" sx={{ '--Avatar-size': '4rem' }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="title-lg">Phy Lymann</Typography>
        ...
        >
          <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
            <Avatar src="https://i.pinimg.com/564x/9f/b6/a3/9fb6a3c24a5cf453689f1104443aa93e.jpg" sx={{ '--Avatar-size': '4rem' }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="title-lg">Bopha</Typography>
            <Typography level="body-sm" sx={{ maxWidth: '24ch' }}>
              Hello, this is my bio and I am a PRO member of MUI. I am a developer and I
              love to code.
            </Typography>
        ...
        >
          <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
            <Avatar src="https://i.pinimg.com/564x/43/2a/da/432ada9e5f828c8efb4bd6cf73c1d27f.jpg" sx={{ '--Avatar-size': '4rem' }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="title-lg">Vathana</Typography>
            <Typography level="body-sm" sx={{ maxWidth: '24ch' }}>
              Hello, this is my bio and I am a PRO member of MUI. I am a developer and I
              love to code.
            </Typography>
        ...
        >
          <CardContent sx={{ alignItems: 'center', textAlign: 'center' }}>
            <Avatar src="https://i.pinimg.com/564x/bd/5d/8c/bd5d8c59743553343e4369d6a23e8c4f.jpg" sx={{ '--Avatar-size': '4rem' }} />
            <Chip
              size="sm"
              variant="soft"
              color="primary"
            ...
            <Typography level="title-lg">Chantha</Typography>
            <Typography level="body-sm" sx={{ maxWidth: '24ch' }}>
              Hello, this is my bio and I am a PRO member of MUI. I am a developer and I
              love to code.
            </Typography>
